			...
			<div class="row">
				...
				<div class="col-xl-8 col-md-8 col-sm-8 col-8 container">
					<h3><center>REGISTER</center></h3>
   			 		<form class="form-group" action="blog-register-process.php" id="register" method="post" onsubmit="return validation()">
		   			 	<div class="row">
		                ...
		                <div class="row">
		        			...
		        			<div class="col-xl-6 col-md-6 col-sm-6 col-6">
		        			    <label><input type="text" name="firstname" id="firstname" placeholder="John" class="form-control" onchange="validatename(this.id)"  pattern="[A-Za-z].{2,}" title="Please write your name more than 2 letter" maxlength="20"></label>
		                ...
		                <div class="row">
		        			...
		        			<div class="col-xl-6 col-md-6 col-sm-6 col-6">
		        			    <label><input type="text" name="lastname" id="lastname" placeholder="Smith" class="form-control" onchange="validatelastname(this.id)" pattern="[A-Za-z].{2,}" title="Please write your name more than 2 letter"  maxlength="20"></label>
		                ...
		                <div class="row">
		        			...
		        			<div class="col-xl-6 col-md-6 col-sm-6 col-6">
		        			    <label><input type="text" name="email" id="email" placeholder="JohnSmith14@gmail.com" class="form-control"  maxlength="50"></label>
		                ...
		                <div class="row">
		        			...
		        			<div class="col-xl-6 col-md-6 col-sm-6 col-6">
		        			    <label><input type="text" name="mobileno" id="mobileno" placeholder="9413123321" class="form-control" maxlength="10"></label> <br><span id="span_mobile" class="red">
		                    </div>
		                </div>
		                <div class="row">
		   			 		<div class="col-xl-6 col-md-6 col-sm-6 col-6">
		                ...
		                <div class="row">
		        			...
		        			<div class="col-xl-6 col-md-6 col-sm-6 col-6">
		        			    <label><textarea class="form-control" name="information" id="information"></textarea></label>
