...
<div class="container">
  ...
  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
    <form class="form-group" action="contact-edit-process.php?id=<?php echo $id; ?>" method="post" onsubmit="return validation()" enctype="multipart/form-data">
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
             CHOOSE YOUR PHOTO:
             <div class="preview">
                  <img class="preview-img" src="<?php echo $photo?>" alt="Preview Image" width="200" height="400" />
