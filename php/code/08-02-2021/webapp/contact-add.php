...
<div class="container">
  ...
  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
    <form class="form-group" action="contact-add-process.php" id="contact" method="post" onsubmit="return validation()">
      <div class="row">
      ...
      <div class="row">
        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
          <input type="text" name="mobileno" id="mobileno" placeholder="9412134421" class="form-control">
           <br><span id="span_mobileno" class="red"></span>
        </div>
        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
          <input type="text" name="employee"  id="employee" placeholder="Employee" class="form-control">
      ...
      <div class="row">
        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
           <input type="datetime-local" name="created" id="created" placeholder="06/02/2021 19:00" class="form-control">
