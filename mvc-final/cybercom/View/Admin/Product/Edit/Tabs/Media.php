...
<form action="<?php echo $this->getUrl()->getUrl('save','Product_Media');?>" enctype="multipart/form-data"  method="post">
...
<script>
    function submitForm(button){
        ...
        form.attr('action', "<?php echo $this->getUrl()->getUrl('update','Product_Media'); ?>");
        form.submit();
        // e.preventDefault();
    }
    ...
    function deleteMedia(button) {  
        var form = $(button).closest('form');
        form.attr('action',"<?php echo $this->getUrl()->getUrl('delete','Product_Media'); ?>");
        form.submit();
    }
</script>
